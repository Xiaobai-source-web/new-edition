...
def main():
    ...
    <style>
        ...
        /* 文件上传组件：加宽加高、中文化提示（只作用于拖放区，不影响已选文件列表） */
        [data-testid="stFileUploaderDropzone"] { min-height: 96px; width: 100%; }
        [data-testid="stFileUploaderDropzone"] > div:first-child { color: rgba(49, 51, 63, 0.8); font-size: 1.05rem; line-height: 1.5; text-align: center; padding: 16px 8px; }
        ...
        [data-testid="stFileUploaderDropzone"] > div:first-child::before { content: "将文件拖放到此处（或点击选择）"; color: rgba(49, 51, 63, 0.8); display: block; font-size: 1.05rem; line-height: 1.5; }
        [data-testid="stFileUploaderDropzone"] > div:first-child::after { content: "支持 .docx / .txt / .json 等，每个文件 200MB"; color: rgba(49, 51, 63, 0.6); display: block; font-size: 0.85rem; margin-top: 6px; }
